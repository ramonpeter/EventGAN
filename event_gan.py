...
class EventGAN:
    def __init__(
        ...
        **kwargs,
        ...
        4 vectors. The specify the process to train on
    ...
    def get_generator(
        self, n_particles: int, n_units: int, n_layers: int, name="Generator"
    ):
        ...
        # Get 4-momenta
        four_momenta = LorentzVector(n_particles=n_particles, name="4-momenta")(
    ...
    def get_discriminator(
        self, n_particles: int, n_units: int, n_layers: int, name="Discriminator"
    ):
        """Generator model for the EventGAN framework
        ----------
        Args:
